          ...
          <div className='lg:col-span-2'>
            ...
            {project.testUrl && (project.user || project.password) && (
              <div className='bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6'>
                <h3 className='text-lg font-bold mb-2 text-orange-800'>
                  Test Credentials
                </h3>
                <div className='text-orange-700 text-sm space-y-1'>
                  {project.user && (
                    <div>
                      ...
                      <code className='ml-2 bg-orange-100 px-2 py-1 rounded'>
                        {project.user}
                      </code>
                    </div>
                  )}
            ...
            {/* Mobile Apps Section */}
            {project.mobileApps && project.mobileApps.length > 0 && (
              <div className='mb-6'>
                <h3 className='text-xl font-bold mb-4'>Mobile Applications</h3>
                <div className='space-y-6'>
                  {project.mobileApps.map((app, appIndex) => (
                    <div
                      key={appIndex}
                      className='bg-surface-300 rounded-lg p-4 border border-surface-400'
                    >
                      ...
                      <div className='flex flex-wrap gap-2 mb-4'>
                        {app.playStoreUrl && (
                          <a
                            ...
                            className='transition-all bg-green-600 hover:bg-green-500 text-white py-2 px-3 rounded text-sm flex items-center'
                          >
                            <svg
                        ...
                        {app.appStoreUrl && (
                          <a
                            ...
                            target='_blank'
                            rel='noopener noreferrer'
                            className='transition-all bg-blue-600 hover:bg-blue-500 text-white py-2 px-3 rounded text-sm flex items-center'
                          >
                            <svg
                              className='w-4 h-4 mr-1'
                              fill='currentColor'
                        ...
                        {app.apkUrl && (
                          <a
                            ...
                            target='_blank'
                            rel='noopener noreferrer'
                            className='transition-all bg-emerald-700 hover:bg-emerald-600 text-white py-2 px-3 rounded text-sm flex items-center'
                          >
                            <svg
                              className='w-4 h-4 mr-1'
                              fill='none'
                        ...
                        {app.demoVideoUrl && (
                          <a
                            ...
                            target='_blank'
                            rel='noopener noreferrer'
                            className='transition-all bg-red-600 hover:bg-red-500 text-white py-2 px-3 rounded text-sm flex items-center'
                          >
                            <svg
                              className='w-4 h-4 mr-1'
                              fill='none'
                ...
                <a
                  ...
                  title={
                    project.user && project.password
                      ? `Test credentials: ${project.user} / ${project.password}`
                      : 'Test version'
                  }
                >
                  <svg
